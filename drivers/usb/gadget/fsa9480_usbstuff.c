...
extern u8 MicroUSBStatus;
extern u8 MicroJigUSBOnStatus;
extern u8 MicroJigUSBOffStatus;
...
// }
// 
extern int fsa9480_read(struct i2c_client *client, u8 reg, u8 *data);
// {
// 
// 	int ret;
// 	u8 buf[1];
...
// 
// 
extern int fsa9480_write(struct i2c_client *client, u8 reg, u8 data);
// {
// 
// 	int ret;
// 	u8 buf[2];
...
// 
extern void usb_switching_value_update(int value);
// {
// 	if(value == SWITCH_PDA)
// 		usb_message[0] = 'A';
// 	else
...
// }
// 
extern void uart_switching_value_update(int value);
// {
// 	if(value == SWITCH_PDA)
// 		uart_message[0] = 'A';
// 	else
...
// }
// 
extern void switching_value_update(void);
// {
// 	int index;
// 	
