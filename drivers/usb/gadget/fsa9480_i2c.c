...
static u8 MicroUSBStatus=0; EXPORT_SYMBOL(MicroUSBStatus);
static u8 MicroJigUSBOnStatus=0; EXPORT_SYMBOL(MicroJigUSBOnStatus);
static u8 MicroJigUSBOffStatus=0; EXPORT_SYMBOL(MicroJigUSBOffStatus);
static u8 MicroJigUARTOffStatus=0; EXPORT_SYMBOL(MicroJigUARTOffStatus);
u8 MicroTAstatus=0;
...
EXPORT_SYMBOL(fsa9480_i2c_client);
